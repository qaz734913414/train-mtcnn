...
from core.symbol import P_Net16, R_Net, O_Net
from core.imdb import IMDB
from core.loader import TestLoader
from core.detector import Detector
from core.fcn_detector import FcnDetector
from tools.load_model import load_param
from core.MtcnnDetector16 import MtcnnDetector
from utils import *
...
def creat_mtcnn_detector(prefix, epoch, batch_size, test_mode, thresh, min_face_size, ctx):
    ...
    PNet = FcnDetector(P_Net16("test"), ctx, args, auxs)
    detectors[0] = PNet
...
def parse_args():
    ...
    parser.add_argument('--test_mode', dest='test_mode', help='test net type, can be hardpnet16, rnet, hardrnet or onet, hardonet',
                        default='hardpnet16', type=str)
    parser.add_argument('--prefix', dest='prefix', help='prefix of model name',
                        default='%s/model/pnet16'%config.root+',%s/model/rnet'%config.root+',%s/model/onet'%config.root, type=str)
