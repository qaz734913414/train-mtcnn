...
def L106_Net112(mode="train"):
    ...
    conv2 = Residual(conv1, num_block=2, num_out= res_base_dim, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=res_base_dim, name="res2")
    
	#conv23 = 28X28
    conv23 = DResidual(conv2, num_out=res_base_dim*2, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=res_base_dim*2, name="dconv23")
    conv3 = Residual(conv23, num_block=6, num_out=res_base_dim*2, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=res_base_dim*2, name="res3")
    
	#conv34 = 14X14
    conv34 = DResidual(conv3, num_out=res_base_dim*4, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=res_base_dim*4, name="dconv34")
    conv4 = Residual(conv34, num_block=10, num_out=res_base_dim*4, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=res_base_dim*4, name="res4")
	...
	# conv6 = 1x1
    conv6 = Conv(conv5, num_filter=res_base_dim*8, num_group=res_base_dim*8, kernel=(7, 7), pad=(0, 0), stride=(1, 1), name="conv6")
    fc1 = mx.symbol.FullyConnected(data=conv6, num_hidden=128, name="fc1")	
    fc2 = mx.symbol.FullyConnected(data=fc1, num_hidden=128, name="fc2")	
