...
img_path = '../data_cut/'
out_img_path = '../data_cut_migu/'

with open('../cut_landmarks.txt', 'r') as f:
    landmark_lines = f.readlines()
f = open('../cut_landmarks_migu.txt','w')
...
for i in range(num):
    ...
    if bbox[2] >= 20 and bbox[3] >= 20 and bbox[0]+bbox[2] <= width and bbox[1]+bbox[3] <= height:
        ...
        if cut_width > 300 and cut_height > 300:
            scale = 300.0/min(cut_width,cut_height)
