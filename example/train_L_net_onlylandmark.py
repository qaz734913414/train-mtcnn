...
from core.imdb_onlylandmark import IMDB
from train_onlylandmark import train_net
...
def train_L_net(image_set, root_path, dataset_path, prefix, ctx,
    ...
    train_net(sym, prefix, ctx, pretrained, epoch, begin_epoch, end_epoch, gt_imdb, batch_size, thread_num,
              48, False, False, True, frequent, not resume, lr, lr_epoch)

def parse_args():
    parser = argparse.ArgumentParser(description='Train L_Net(48-net)',
