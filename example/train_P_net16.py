...
from core.symbol import P_Net16

def train_P_net16(image_set, root_path, dataset_path, prefix, ctx,
    ...
    train_net(sym, prefix, ctx, pretrained, epoch, begin_epoch, end_epoch, gt_imdb, batch_size, thread_num,
              16, True, True, False, frequent, not resume, lr, lr_epoch)
...
if __name__ == '__main__':
    ...
    train_P_net16(args.image_set, args.root_path, args.dataset_path, args.prefix, ctx,
