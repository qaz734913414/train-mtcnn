...
from train_onlylandmark17 import train_net
from core.symbol import L17_Net112
...
def parse_args():
    ...
    parser.add_argument('--image_set', dest='image_set', help='training set',
                        default='cut_train2017_anno', type=str)
    ...
    parser.add_argument('--prefix', dest='prefix', help='new model prefix',
                        default='model/lnet17_112', type=str)
